						...
						<div className="flex-1 space-y-4 overflow-y-auto px-4">
							...
							<FormField
								...
								rules={{
									...
									validate: {
										format: (v) =>
											/^[a-zA-Z0-9_]+$/.test(v) || "Server name can only contain letters, numbers, and underscores",
											...
											<TooltipProvider>
												<Tooltip>
													...
													<TooltipContent className="max-w-xs">
														<p>
															Enable to use lightweight ping method for health checks. Disable if your MCP server doesn't support ping - will
															use listTools instead.
														</p>
													</TooltipContent>
												</Tooltip>
											</TooltipProvider>
									...
									<FormField
										...
										render={({ field }) => (
											<FormItem className="w-full">
												...
												<Select
													value={field.value}
													onValueChange={(value: MCPAuthType) => field.onChange(value)}
												>
													<FormControl>
														...
														<div className="flex items-center gap-2">
															...
															<TooltipProvider>
																<Tooltip>
																	...
																	<TooltipContent className="max-w-xs">
																		<p>
																			Leave empty to use Dynamic Client Registration (RFC 7591). Bifrost will automatically register with the
																			OAuth provider if supported.
																		</p>
																	</TooltipContent>
																</Tooltip>
															</TooltipProvider>
