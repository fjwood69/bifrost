...
require (
	...
	github.com/maximhq/bifrost/plugins/compat v0.1.3
	github.com/maximhq/bifrost/plugins/governance v1.5.4
	github.com/maximhq/bifrost/plugins/logging v1.5.4
	github.com/maximhq/bifrost/plugins/maxim v1.6.4
	github.com/maximhq/bifrost/plugins/otel v1.2.4
	github.com/maximhq/bifrost/plugins/prompts v1.0.4
	github.com/maximhq/bifrost/plugins/semanticcache v1.5.4
	github.com/maximhq/bifrost/plugins/telemetry v1.5.4
