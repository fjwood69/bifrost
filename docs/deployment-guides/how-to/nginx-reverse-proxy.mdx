...
- [Example folder](https://github.com/maximhq/bifrost/tree/main/examples/configs/withnginxreverseproxy)
- [docker-compose.yml](https://github.com/maximhq/bifrost/blob/main/examples/configs/withnginxreverseproxy/docker-compose.yml)
- [nginx.conf](https://github.com/maximhq/bifrost/blob/main/examples/configs/withnginxreverseproxy/nginx.conf)
- [config.json](https://github.com/maximhq/bifrost/blob/main/examples/configs/withnginxreverseproxy/config.json)
- [.env.example](https://github.com/maximhq/bifrost/blob/main/examples/configs/withnginxreverseproxy/.env.example)
